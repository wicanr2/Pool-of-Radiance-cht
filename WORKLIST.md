...
- [ ] **探針在古托井（諾里斯）全滅、「獎賞買板甲」走不到：與攻略比對觸發、編成、獎賞與順序。** house rule 探針 seed 137 一級下井撞諾里斯＋5 蜥蜴人（AC 4）＋9 狗頭人首領，八回合全滅；#29／#30 之後的「獎賞買板甲、回訓練所升級」那一段因此走不到。攻略說井邊中立、市議會沒有懸賞、索卡爾城堡可用密語過巡邏——與 spec 137 的獎賞表與建議順序要對一次。
      **卡在**：戰術層歸 #22；路線表整欄歸 #26，這裡只判古托井前後這一段。
      **驗收**：觸發／獎賞／編成／順序四件事各有 ECL 位址或 dosgolem 收據；探針走到 outfit 買板甲與 L2 那一行，或記下在哪一場、什麼等級、命中率多少全滅。
      **討論**：[#37](https://github.com/wicanr2/Pool-of-Radiance-cht/issues/37)
