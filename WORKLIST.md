...
- [ ] **戰鬥缺 BANDAGE：倒地的隊員九回合後必死。** 原版戰鬥指令列有 BANDAGE；remake 沒有，倒地者九回合後轉死亡，一級隊伍付不起復活。
      **驗收**：讀出原版入口與效果接進戰術輸入；駕駛在有人倒地時先包紮。
      **討論**：[#25](https://github.com/wicanr2/Pool-of-Radiance-cht/issues/25)
