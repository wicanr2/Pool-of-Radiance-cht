...
- [ ] **陣型樣板 DS:43A2h 的來源要從原版執行期追蹤確認。** 樣板是 1A99h 用 DS:304h 填的，目前靜態讀出；要 dosgolem 在四場開打那一幀讀 43A2h 的 528 bytes 對 remake 的 FillDeploymentTemplates，追 304h／43A2h 的所有寫入端，陣型 1..3 找一筆執行期收據。
      **驗收**：四場樣板 528 bytes 逐 byte 相同並釘測試；寫入端清單進 spec 061；陣型 1..3 至少一筆收據或寫明踩不到。
      **討論**：[#35](https://github.com/wicanr2/Pool-of-Radiance-cht/issues/35)
