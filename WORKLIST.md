...
- [ ] **走得到的內容量到了**（2026-09-03）：六個種子各走 6000 步，走到
  ...
  **但區塊 9 還是沒開。** 再量一次換圖點：34 趟裡只有 **2 趟**走到 GEO1/18，
  而且兩趟都是從野外（GEO5/5 的 (11,28)）進去的——走完野外預算也差不多用完，
  沒有機會在那張圖上輪出口。所以卡的不是出口挑法，是**那張圖太晚才到得了**。
  下一步是給它一趟自己的：巡迴多一種主線狀態，或讓野外那一段之後還留得下
  預算。
