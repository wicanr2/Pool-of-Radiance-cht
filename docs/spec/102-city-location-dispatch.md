...
| 0 | 9 | (14,8) 東、(11,9) 南、(12,9) 南、(13,9) 北、(10,10) 西、(7,11) 東、(10,11) 東、(8,12) 南、(9,12) 北、(10,12) 東與南 | 三家店的門，見下表 |
| 4 | 7 | 沒有 | —— |

地形 4 牆型 7 掃不到，而 remake 投影
...
## 那十一扇門是哪幾棟（2026-09-19，#39 收尾，`exact`）

晚上站在街上面對牆型 9 會問「THE DOOR IS LOCKED. DO YOU WANT TO BREAK IN?」
（`9920h` 那一支）。**面對的是哪幾棟，靠兩份原版資料就答得完**：GEO3/0 的牆面，
加上門後那一格的 `terrain & 0x7F`——也就是上面那張 28 項 `ON GOTO` 的索引。
...
| (10,10) 西 | (9,10) | 19 | 雜貨店 |
| (7,11) 東 | (8,11) | 22 | 武具店 |
| (10,11) 東 | (11,11) | 19 | 雜貨店 |
| (8,12) 南 | (8,13) | 22 | 武具店 |
| (9,12) 北 | (9,11) | 19 | 雜貨店 |
| (10,12) 東 | (11,12) | 22 | 武具店 |
| (10,12) 南 | (10,13) | 23 | 銀器店 |

**三家店，一家民宅都沒有**：雜貨店五扇、武具店四扇、銀器店兩扇。索引 22（武具店）
在圖上有五格，只有四格有門——第五格從店內側相鄰，街上沒有對著它的門面。

掃出來的門面實際是 22 個，因為同一扇門兩側各算一面；表上列的是**街那一側**
（地點索引 0），也就是問句真的會出現的那一側。釘住它的是
`TestCityDoorFacesMapToTheThreeShops`（`internal/gamepack`），資料一換就紅。
...
「THE DOOR IS LOCKED. DO YOU WANT TO BREAK IN?」——那個問句面對的是牆型 9 的那十一扇門，
也就是上一節那三家店。
