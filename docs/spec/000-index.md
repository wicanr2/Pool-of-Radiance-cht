...
140 份規格，其中 0 份還沒有任何檔案的註解指回它、0 份沒有測試提到它；
...
| [074](074-spell-parameters-and-messages.md) | 法術參數表與效果訊息 | CONFORMED＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/encounter.go`、`cmd/pool-game/main.go` 等 8 個 | `cmd/pool-disp-scan/main_test.go`、`cmd/pool-game/cast_test.go`、`cmd/pool-game/spells_test.go` 等 6 個 |
...
| [078](078-encounter-menu-opcode.md) | `29h ENCOUNTER MENU` | CONFORMED＋READY＋DRAFT | `cmd/pool-game/encounter.go`、`cmd/pool-game/main.go`、`cmd/pool-game/tactical.go` 等 8 個 | `cmd/pool-game/door_test.go`、`cmd/pool-game/encounter_distance_test.go`、`internal/gamepack/encounter_test.go` |
...
| [102](102-city-location-dispatch.md) | 城區的地點是 terrain 索引分派的，而且有些要面對它 | READY | `cmd/pool-game/main.go`、`cmd/pool-map-names/main.go`、`internal/gamepack/game_clock.go` | `cmd/pool-game/city_watch_test.go`、`cmd/pool-game/combat_effects_test.go`、`cmd/pool-game/coverage_test.go` 等 11 個 |
...
| [106](106-ecl-address-space.md) | ECL 的位址空間是虛擬的 | READY＋DRAFT | `cmd/pool-disp-scan/main.go`、`cmd/pool-game/main.go`、`cmd/pool-game/training_gate.go` | `cmd/pool-disp-scan/main_test.go`、`cmd/pool-game/playthrough_test.go`、`cmd/pool-game/stojanow_gate_test.go` |
...
| [114](114-camp-rest-time.md) | 遊戲時鐘與紮營的休息時間（overlay-20） | CONFORMED | `cmd/pool-game/camp.go`、`cmd/pool-game/main.go`、`cmd/pool-game/text.go` 等 5 個 | `cmd/pool-disp-scan/main_test.go`、`cmd/pool-game/camp_interruption_test.go`、`cmd/pool-game/camp_screen_test.go` 等 8 個 |
