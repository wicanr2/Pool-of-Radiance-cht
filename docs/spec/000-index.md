...
| [074](074-spell-parameters-and-messages.md) | 法術參數表與效果訊息 | CONFORMED＋READY＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/encounter.go`、`cmd/pool-game/foe_cast.go` 等 9 個 | `cmd/pool-disp-scan/main_test.go`、`cmd/pool-game/cast_test.go`、`cmd/pool-game/spells_test.go` 等 6 個 |
...
| [096](096-monster-ai-structure.md) | 怪物 AI 的骨架（overlay-09） | CONFORMED＋READY | `cmd/pool-game/cast.go`、`cmd/pool-game/foe_cast.go`、`cmd/pool-game/foe_items.go` 等 9 個 | `cmd/pool-game/foe_cast_test.go`、`cmd/pool-game/foe_items_test.go`、`cmd/pool-game/foe_turn_undead_test.go` 等 6 個 |
...
| [098](098-spell-casting-machinery.md) | 施法的共用機制（擲骰、施法者等級、處理常式的呼叫慣例） | CONFORMED＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/foe_cast.go`、`cmd/pool-game/main.go` 等 10 個 | `cmd/pool-game/cast_test.go`、`cmd/pool-game/memorise_test.go`、`internal/gamepack/spell_cast_test.go` |
