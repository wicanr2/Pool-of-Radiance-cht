...
| [096](096-monster-ai-structure.md) | 怪物 AI 的骨架（overlay-09） | CONFORMED＋READY | `cmd/pool-game/cast.go`、`cmd/pool-game/combat_screen.go`、`cmd/pool-game/foe_cast.go` 等 10 個 | `cmd/pool-game/foe_cast_test.go`、`cmd/pool-game/foe_items_test.go`、`cmd/pool-game/foe_turn_undead_test.go` 等 6 個 |
...
| [098](098-spell-casting-machinery.md) | 施法的共用機制（擲骰、施法者等級、處理常式的呼叫慣例） | CONFORMED＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/foe_cast.go`、`cmd/pool-game/main.go` 等 12 個 | `cmd/pool-game/cast_test.go`、`cmd/pool-game/memorise_test.go`、`cmd/pool-game/spell_targets_test.go` 等 4 個 |
