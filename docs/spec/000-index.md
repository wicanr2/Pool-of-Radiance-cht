...
| [096](096-monster-ai-structure.md) | 怪物 AI 的骨架（overlay-09） | CONFORMED＋READY | `cmd/pool-game/cast.go`、`cmd/pool-game/foe_cast.go`、`cmd/pool-game/tactical.go` 等 6 個 | `cmd/pool-game/foe_cast_test.go`、`cmd/pool-game/foe_walk_receipt_test.go`、`internal/gamepack/spell_ai_test.go` 等 4 個 |
...
| [111](111-turn-undead.md) | 轉變不死生物 | READY | `cmd/pool-game/foe_cast.go`、`internal/gamepack/turn_undead_resolve.go` | `internal/journal/manual_tables_test.go` |
...
| [139](139-quick-auto-combat.md) | Q）UICK 自動戰鬥與 M）OVE 的兩層按鍵 | READY＋DRAFT | `cmd/pool-game/foe_cast.go`、`cmd/pool-game/tactical.go`、`cmd/pool-game/text.go` 等 4 個 | `cmd/pool-game/foe_cast_test.go`、`cmd/pool-game/quick_test.go` |
