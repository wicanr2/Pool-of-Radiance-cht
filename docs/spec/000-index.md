...
148 份規格，其中 0 份還沒有任何檔案的註解指回它、0 份沒有測試提到它；
...
| [010](010-dos-initial-rolf-event.md) | DOS 初始 Rolf 導覽事件 | READY＋DRAFT | `internal/gamepack/intro.go` | `internal/gamepack/intro_test.go` |
| [011](011-dos-rolf-guided-tour.md) | DOS Rolf 34-step 導覽與結束交接 | READY＋DRAFT | `internal/gamepack/intro.go` | `internal/gamepack/eclvm_test.go` |
...
| [026](026-city-hall-clerk-entry.md) | City Hall clerk office 正常入口 | CONFORMED | 共用 engine | `cmd/pool-game/main_test.go` |
| [027](027-save-table-opcode.md) | Pool ECL opcode `35h SAVE TABLE` | CONFORMED | 共用 engine | `cmd/pool-doc-index/main_test.go` |
| [028](028-city-hall-reward-commission-loop.md) | City Hall reward／commission 迴圈 | DRAFT | `cmd/pool-city-hall-audit/main.go` | `cmd/pool-city-hall-audit/main_test.go` |
| [029](029-city-hall-fresh-party-commission-exit.md) | 全新隊伍 City Hall 委託列舉與離場 | READY＋DRAFT | 共用 engine | `internal/gamepack/cityhall_test.go` |
...
| [034](034-postcombat-treasure-menu-boundary.md) | 戰後戰利品選單與物品鏈移除邊界 | READY＋DRAFT | `cmd/pool-game/main.go`、`cmd/pool-game/monster_loot.go`、`cmd/pool-game/screen_state.go` | `cmd/pool-game/main_test.go`、`cmd/pool-game/treasure_screen_test.go` |
...
| [036](036-combat-postcombat-treasure-dispatch.md) | `24h COMBAT` 的戰鬥／神殿／戰後服務分派 | CONFORMED＋DRAFT | `cmd/pool-game/loot_experience.go`、`cmd/pool-game/main.go` | `cmd/pool-game/main_test.go` |
...
| [040](040-seven-currency-pool-take-share.md) | 七種貨幣的 View／Take／Pool／Share | READY | `cmd/pool-game/appraise.go`、`cmd/pool-game/shop.go`、`internal/character/export.go` 等 6 個 | `cmd/pool-game/shop_pool_identify_test.go`、`internal/treasure/money_test.go` |
...
| [050](050-basic-attack-and-damage-roll.md) | Pool 基礎命中與傷害骰 primitive | CONFORMED＋DRAFT | `cmd/pool-game/tactical.go`、`internal/gamepack/hit_roll_effects.go` | `cmd/pool-game/dos_combat_parity_test.go`、`internal/combat/rules_test.go` |
| [051](051-attack-slot-phase-count.md) | Pool 雙攻擊槽與半回合攻擊次數 | CONFORMED＋DRAFT | `cmd/pool-game/tactical.go`、`internal/gamepack/hit_roll_effects.go`、`internal/gamepack/monster.go` 等 5 個 | `cmd/pool-game/attack_forms_test.go`、`cmd/pool-game/main_test.go`、`internal/gamepack/monster_test.go` |
...
| [053](053-tactical-movement-budget.md) | Pool 戰術移動預算與八方向成本 | CONFORMED＋DRAFT | `cmd/pool-game/foe_flee.go`、`cmd/pool-game/main.go`、`cmd/pool-game/manual_aim.go` 等 6 個 | `cmd/pool-game/reaction_attack_test.go`、`cmd/pool-game/tactical_test.go` |
...
| [057](057-movement-line-trace.md) | 移動直線追蹤與每步成本 | READY＋DRAFT | `cmd/pool-game/tactical.go`、`internal/combat/nearby.go`、`internal/combat/trace.go` | `internal/combat/trace_test.go` |
...
| [059](059-reaction-attack-gate.md) | 離開威脅區的反應攻擊閘門 | READY＋DRAFT | `cmd/pool-game/reaction_attack.go`、`cmd/pool-game/tactical.go`、`internal/character/export.go` 等 9 個 | `cmd/pool-game/reaction_attack_test.go`、`internal/gamepack/effect_list_test.go`、`internal/gamepack/hit_roll_effects_test.go` |
| [060](060-tactical-map-generation.md) | 戰術地圖的生成 | READY | `cmd/pool-game/battlefield.go`、`cmd/pool-game/combat_screen.go`、`cmd/pool-game/main.go` 等 9 個 | `cmd/pool-game/playthrough_test.go` |
| [061](061-deployment-and-occupancy.md) | 戰鬥部署與佔用格重建 | CONFORMED＋READY＋DRAFT | `cmd/pool-game/encounter.go`、`cmd/pool-game/main.go`、`cmd/pool-game/tactical.go` 等 5 個 | `cmd/pool-game/deployment_templates_receipt_test.go`、`cmd/pool-game/mainline_walls_test.go`、`cmd/pool-game/norris_fight_receipt_test.go` 等 6 個 |
...
| [067](067-shop-service-and-stock.md) | 商店服務邊界與進貨清單 | CONFORMED＋DRAFT | `cmd/pool-game/combat_item_menu.go`、`cmd/pool-game/foe_flee.go`、`cmd/pool-game/main.go` 等 11 個 | `cmd/pool-game/mainline_outfit_test.go`、`cmd/pool-game/shop_sell_test.go`、`cmd/pool-game/shop_walk_test.go` |
| [068](068-spell-name-table.md) | 法術名稱表 | CONFORMED＋DRAFT | `cmd/pool-game/combat_notice.go`、`cmd/pool-game/spells.go`、`internal/gamepack/spell_dispatch.go` 等 4 個 | `cmd/pool-game/combat_notice_test.go`、`internal/gamepack/spell_table_test.go` |
| [069](069-character-effect-list.md) | 角色的效果串列（`.spc`） | CONFORMED＋DRAFT | `cmd/pool-game/combat_effects.go`、`cmd/pool-game/main.go`、`cmd/pool-game/party_panel.go` 等 13 個 | `cmd/pool-game/combat_effects_test.go`、`cmd/pool-game/field_cast_effects_test.go`、`internal/character/export_test.go` 等 5 個 |
...
| [074](074-spell-parameters-and-messages.md) | 法術參數表與效果訊息 | CONFORMED＋READY＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/encounter.go`、`cmd/pool-game/spells.go` 等 8 個 | `cmd/pool-disp-scan/main_test.go`、`cmd/pool-game/cast_test.go`、`cmd/pool-game/spells_test.go` 等 6 個 |
| [075](075-saving-throws.md) | 豁免判定 | CONFORMED＋DRAFT | `cmd/pool-game/damage.go`、`cmd/pool-game/main.go`、`cmd/pool-game/tactical.go` 等 9 個 | `internal/gamepack/saving_throw_test.go` |
...
| [079](079-movement-rate.md) | 移動力 | CONFORMED | `cmd/pool-game/checkparty.go`、`cmd/pool-game/encounter.go`、`cmd/pool-game/party_strength.go` 等 8 個 | `cmd/pool-game/equipment_test.go` |
...
| [091](091-ecl-add-npc-opcode.md) | `36h ADD NPC` | READY＋DRAFT | `cmd/pool-game/addnpc.go`、`cmd/pool-game/tactical.go`、`internal/gamepack/ecl_operands.go` 等 6 個 | `cmd/pool-game/main_test.go`、`cmd/pool-game/mainline_spells_test.go`、`cmd/pool-game/npc_gear_test.go` |
...
| [096](096-monster-ai-structure.md) | 怪物 AI 的骨架（overlay-09） | CONFORMED＋READY | `cmd/pool-game/addnpc.go`、`cmd/pool-game/cast.go`、`cmd/pool-game/combat_screen.go` 等 14 個 | `cmd/pool-game/foe_cast_test.go`、`cmd/pool-game/foe_flee_test.go`、`cmd/pool-game/foe_items_test.go` 等 7 個 |
| [097](097-training-level-up-and-energy-drain.md) | 經驗值、訓練所昇級、生命骰與能量吸取 | CONFORMED＋DRAFT | `cmd/pool-game/addnpc.go`、`cmd/pool-game/loot_experience.go`、`cmd/pool-game/main.go` 等 15 個 | `cmd/pool-game/cast_test.go`、`cmd/pool-game/door_test.go`、`cmd/pool-game/experience_test.go` 等 9 個 |
| [098](098-spell-casting-machinery.md) | 施法的共用機制（擲骰、施法者等級、處理常式的呼叫慣例） | CONFORMED＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/combat_notice.go`、`cmd/pool-game/damage_interrupt.go` 等 28 個 | `cmd/pool-game/cast_test.go`、`cmd/pool-game/combat_notice_test.go`、`cmd/pool-game/field_cast_effects_test.go` 等 11 個 |
...
| [106](106-ecl-address-space.md) | ECL 的位址空間是虛擬的 | CONFORMED＋READY＋DRAFT | `cmd/pool-disp-scan/main.go`、`cmd/pool-game/main.go`、`cmd/pool-game/training_gate.go` 等 4 個 | `cmd/pool-disp-scan/main_test.go`、`cmd/pool-game/block_load_test.go`、`cmd/pool-game/coverage_test.go` 等 6 個 |
| [107](107-newecl-ff-sentinel.md) | `NEWECL FFh` 是「不換區塊」 | READY | `internal/gamepack/intro.go` | `cmd/pool-game/coverage_test.go` |
| [108](108-ending-cutscene.md) | 結局過場（overlay-18 entry 1） | READY＋DRAFT | `cmd/pool-game/ending.go`、`cmd/pool-game/main.go`、`cmd/pool-game/program.go` 等 6 個 | `cmd/pool-game/mainline_probe_test.go`、`cmd/pool-game/playthrough_test.go`、`internal/assets/ending_test.go` 等 4 個 |
...
| [110](110-spellbook.md) | 法術書（角色記錄 `+32h + 編號`） | CONFORMED＋DRAFT | `cmd/pool-game/spellbook.go`、`cmd/pool-game/spells.go`、`internal/gamepack/spellbook.go` 等 4 個 | `cmd/pool-game/mainline_spells_test.go`、`cmd/pool-game/memorise_test.go`、`cmd/pool-game/spellbook_test.go` 等 4 個 |
| [111](111-turn-undead.md) | 轉變不死生物 | READY | `cmd/pool-game/foe_cast.go`、`cmd/pool-game/foe_turn_undead.go`、`cmd/pool-game/main.go` 等 5 個 | `internal/journal/manual_tables_test.go` |
| [112](112-effect-code-dispatch.md) | 效果代碼的分派（overlay-24 entry 3／entry 1 與 `014Dh`） | READY＋OPEN | `cmd/pool-game/combat_effects.go`、`cmd/pool-game/foe_cast.go`、`cmd/pool-game/hit_roll_effects.go` 等 18 個 | `cmd/pool-game/cast_test.go`、`cmd/pool-game/hit_roll_effects_test.go`、`cmd/pool-game/save_damage_effects_test.go` 等 9 個 |
...
| [121](121-cloud-objects.md) | 盤面上的雲團物件 | READY＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/cloud.go`、`cmd/pool-game/missile.go` 等 9 個 | `cmd/pool-game/cloud_test.go`、`internal/gamepack/cloud_test.go`、`internal/gamepack/spell_cast_test.go` |
| [122](122-locked-doors.md) | 鎖住的門（`Bash`／`Pick`／`Knock`） | CONFORMED＋DRAFT | `cmd/pool-disp-scan/main.go`、`cmd/pool-game/door.go`、`cmd/pool-game/main.go` 等 4 個 | `cmd/pool-doc-index/main_test.go`、`cmd/pool-game/door_test.go`、`cmd/pool-game/journal_link_test.go` 等 6 個 |
...
| [124](124-map-names-from-the-original.md) | 地圖的名字要從原版自己的文字取 | READY＋DRAFT | `cmd/pool-doc-index/main.go`、`cmd/pool-map-names/main.go` | `cmd/pool-map-names/main_test.go` |
...
| [136](136-slum-encounter-staging.md) | 貧民窟走一步會遇到什麼 | CONFORMED＋READY＋DRAFT | `cmd/pool-game/foe_flee.go`、`cmd/pool-game/main.go`、`cmd/pool-game/tactical.go` 等 4 個 | `cmd/pool-game/main_test.go`、`cmd/pool-game/mainline_probe_test.go`、`cmd/pool-game/wandering_encounter_e2e_test.go` 等 5 個 |
...
| [140](140-house-rule-commission-experience.md) | 自訂規則——委任經驗值加倍（預設關） | CONFORMED＋READY | `cmd/pool-game/main.go`、`cmd/pool-game/party_menu.go`、`cmd/pool-game/text.go` 等 4 個 | `cmd/pool-game/mainline_house_rule_test.go`、`cmd/pool-game/mainline_probe_test.go` |
...
| [142](142-monster-item-chain-and-loot.md) | 怪物的物品串列——從哪裡載、誰用、戰後怎麼交出來 | READY＋DRAFT | `cmd/pool-game/addnpc.go`、`cmd/pool-game/foe_items.go`、`cmd/pool-game/main.go` 等 8 個 | `cmd/pool-game/main_test.go`、`cmd/pool-game/mainline_castle_test.go`、`cmd/pool-game/mainline_probe_test.go` 等 10 個 |
| [144](144-combat-item-menu.md) | 戰鬥中的物品選單——Ready、Drop、Halve、Join、卷軸與 `+0Bh` 為 0 的物品法術 | READY＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/combat_commands.go`、`cmd/pool-game/combat_item_menu.go` 等 8 個 | `cmd/pool-game/combat_item_menu_test.go`、`cmd/pool-game/field_cast_effects_test.go`、`cmd/pool-game/item_page_test.go` 等 4 個 |
| [145](145-race-effects-at-creation.md) | 建角依種族掛的效果 | CONFORMED | `cmd/pool-game/main.go`、`cmd/pool-game/race_effects.go`、`internal/gamepack/race_effects.go` 等 4 個 | `cmd/pool-game/race_effects_test.go` |
| [147](147-monster-gear-recompute.md) | 怪物開打時的裝備重算（overlay-25 entry 7） | CONFORMED＋READY＋DRAFT | `cmd/pool-game/addnpc.go`、`cmd/pool-game/combat_item_menu.go`、`cmd/pool-game/monster_gear.go` 等 5 個 | `cmd/pool-game/monster_gear_test.go`、`cmd/pool-game/norris_fight_receipt_test.go`、`cmd/pool-game/npc_gear_test.go` 等 5 個 |
| [148](148-loot-experience-and-npc-share.md) | 戰利品折算經驗值與 NPC 分錢 | CONFORMED＋READY＋DRAFT | `cmd/pool-game/loot_experience.go`、`cmd/pool-game/main.go`、`cmd/pool-game/monster_loot.go` 等 5 個 | `cmd/pool-game/house_rule_test.go`、`cmd/pool-game/loot_experience_test.go`、`cmd/pool-game/mainline_probe_test.go` |
| [149](149-exploration-item-menu-and-wear-effects.md) | 探索中的物品頁與穿戴效果——Ready 不換手、Use／Drop／Halve／Join、`+3Eh` 效果碼 | READY＋DRAFT | `cmd/pool-game/item_page.go`、`internal/gamepack/item_menu.go`、`internal/gamepack/wear_effect.go` | `cmd/pool-game/equipment_test.go`、`cmd/pool-game/field_cast_effects_test.go`、`cmd/pool-game/item_page_test.go` 等 4 個 |
| [151](151-missile-ammunition-and-ai-weapon-choice.md) | 射擊、彈藥與 AI 換武器（overlay-25 entry 43／44／45、overlay-13 射擊路徑、overlay-09 entry 9） | READY＋DRAFT | `cmd/pool-game/cast.go`、`cmd/pool-game/missile.go`、`cmd/pool-game/monster_loot.go` 等 6 個 | `cmd/pool-game/missile_test.go`、`cmd/pool-game/monster_gear_test.go` |
...
| `export-title` | 把原版的標題畫面從 DAX 解出來寫成 PNG，給對拍與說明文件用 | 有 | 001 |
...
| `pool-combat-icon-audit` | inventories Pool's complete combat-icon archives through the reusable engine decoder | 有 | 007 |
| `pool-disp-scan` | 找 overlay 與 START.EXE 裡對某個位址／位移的記憶體存取 | 有 | 017、074、100、106、114、117 等 8 份 |
| `pool-doc-index` | 產生 docs/spec/000-index.md：每份規格的狀態、實作它的檔案、釘住它的測試，以及 cmd/ 底下每一支工具在做什麼 | 有 | 027、066、100、122、123、124 等 7 份 |
...
| `pool-game` | remake 的遊戲本體：Ebiten 視窗、玩家輸入、畫面，以及與共用 engine 和 game pack 的接線 | 有 | 003、005、007、008、012、014 等 120 份 |
...
| `pool-world-cell-sweep` | 把每一張地圖的每一格都餵進它自己的 ECL 區塊，跑入口 0 再跑入口 1，記下停在哪一種邊界 | 有 | 043、103 |
