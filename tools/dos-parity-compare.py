...
def main():
    ...
    plan = [
        ...
        {"name": "camp-alter", "kind": "layout", "view": True,
         "digest": "6a8df192", "remake": "remake-camp-alter.png",
         "note": "紮營 ALTER 子畫面（spec 135）"},
        {"name": "camp-speed", "kind": "layout", "view": True,
         "digest": "be1f8279", "remake": "remake-camp-speed.png",
         "note": "紮營 ALTER／SPEED 子畫面（spec 135）"},
        {"name": "camp-pics", "kind": "layout", "view": True,
         "digest": "9e0c0a9b", "remake": "remake-camp-pics.png",
         "note": "紮營 ALTER／PICS 子畫面（spec 135）"},
        {"name": "camp-icon", "kind": "layout",
         "digest": "60fbf041", "remake": "remake-camp-icon.png",
         "note": "紮營 ALTER／ICON 的戰鬥造形編輯器（spec 135）"},
        {"name": "camp-order-select", "kind": "layout", "view": True,
         "digest": "b93ebba1", "remake": "remake-camp-order-select.png",
         "note": "紮營 ALTER／ORDER 選人（spec 135）"},
        {"name": "camp-order-place", "kind": "layout", "view": True,
         "digest": "5c8e0fcc", "remake": "remake-camp-order-place.png",
         "note": "紮營 ALTER／ORDER 放置位置（spec 135）"},
